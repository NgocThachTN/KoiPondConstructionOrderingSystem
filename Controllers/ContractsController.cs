...
using KoiPond.DTOs;
using KoiPond.AutoMapper;  // Include this to access ContractMapper and RequestMapper
...
namespace KoiPond.Controllers
{
    ...
    public class ContractsController : ControllerBase
    {
        ...
        public ContractsController(IContractsRepository repository, KoiContext context)
        {
