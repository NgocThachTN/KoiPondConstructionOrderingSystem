                ...
                <nav className="navigation navbar navbar-expand-lg navbar-light">
                    <div className="container-fluid">
                        <div className="row align-items-center">
                                        ...
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                ...
                                                <li className="menu-item-has-children">
                                                    ...
                                                    <ul className="sub-menu">
                                                        <li><Link onClick={ClickHandler} href="/blog-single/Best-Architecture-Design">Blog details right sidebar</Link></li>
                                                        <li><Link onClick={ClickHandler} href="/blog-single-left-sidebar/Best-Architecture-Design">Blog details left sidebar</Link></li>
                                                        <li><Link onClick={ClickHandler} href="/blog-single-fullwidth/Best-Architecture-Design">Blog details fullwidth</Link></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                                    ...
                                                    <div className="widget wpo-contact-widget">
                                                        ...
                                                        <div className="contact-ft">
                                                            <ul>
                                                                ...
                                                                <li><i className="fi flaticon-telephone"></i>+ 8 (123) 123 456 789 <br /> + 8 (123) 123 456 789</li>
                            ...
                            <div className="col-lg-1 col-md-1 col-2">
                                <Link onClick={ClickHandler} href="/login" className="btn btn-login">Login</Link>
                            </div>
                        </div>
                    </div>
                </nav>
